...
Production-ready infrastructure automation scripts for cloud provisioning, CI/CD pipelines, and DevOps workflows using Terraform, AWS, and modern DevOps tools.
